...
# no need for color transformation
NAME_TO_MASKOP = {
    'AutoContrast': None,
    'Equalize': None,
    'Invert': None,
...
class AugmentOp:
    ...
    def __init__(self, name, prob=0.5, magnitude=10, hparams=None):
        ...
        self.mask_fn = NAME_TO_MASKOP[name]
    ...
    def __call__(self, img, mask):
        ...
        if self.mask_fn is not None:
            aug_mask = self.mask_fn(mask, *level_args)
        else:
            aug_mask = mask
        return self.aug_fn(img, *level_args, **self.kwargs), aug_mask
